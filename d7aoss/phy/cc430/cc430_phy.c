...
//							0x18, 0x22, 0xF, 0x17, 0xD, 0xC, 0x31, 0xB, 0x15, 0x9, 0x14, 0x21, 0x7, 0x13, 0x5, 0x4, 0x12, 0x3, 0x11, 0x1, 0x10, 0x30, 0x0}; //103
									...
									//9.9 9.5 9.2 8.5 8.1 7.4 7.1 6.4 6.0 5.5 5.1 4.4 4.0 3.6 3.2 2.3 2.0 1.4 0.1 -0.5 -0.9 -1.5 -2.1 -2.5 -3.0 -3.5 ->
static int8_t eirp_reg_values[100]={0xC0, 0xC1, 0xC2, 0xC4, 0xC5, 0xC7, 0xC8, 0xCA, 0x81, 0xCD, 0x84, 0x86, 0x87, 0x88, 0x89, 0x8B, 0xCF, 0x8D, 0x8E, 0x50, // 10 -> 0.5
									0x60, 0x61, 0x52, 0x53, 0x3C, 0x3B, 0x2F, 0x2E, 0x57, 0x8F, 0x68, 0x37, 0x2A, 0x6B, 0x29, 0x6D, 0x28, 0x35, 0x6E, 0x26, // 0 -> -9.5
									0x34, 0x34, 0x25, 0x25, 0x33, 0x33, 0x24, 0x24, 0x1E, 0x1E, 0x1D, 0x6F, 0x32, 0x1B, 0x1A, 0x19, 0x19, 0x18, 0x22, 0x0F, // -10 ->  -19.5
									0x0E, 0x0D, 0x0C, 0x31, 0x0B, 0x15, 0x09, 0x09, 0x08, 0x21, 0x07, 0x07, 0x06, 0x06, 0x05, 0x05, 0x05, 0x04, 0x04, 0x04, // -20 -> -29.5
									0x03, 0x03, 0x03, 0x03, 0x11, 0x11, 0x11, 0x11, 0x11, 0x01, 0x01, 0x01, 0x01, 0x01, 0x10, 0x10, 0x10, 0x30, 0x30, 0x30};// -30 -> -39.5
...
void set_eirp(int8_t eirp)
{
	...
	//TODO write single value or wramp up sequence?
	WriteSinglePATable(eirp_reg_values[index]);
}
